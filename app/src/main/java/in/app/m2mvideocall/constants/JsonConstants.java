package in.app.m2mvideocall.constants;

public final class JsonConstants {

    //Chat constants
    public static final String OUTBOUND_MSG = "OUTBOUND_MSG";
    public static final String INBOUND_MSG = "INBOUND_MSG";
    ...
    public static final String MESSAGE_TYPE_DOCUMENT = "MESSAGE_TYPE_DOCUMENT";
    public static final String MESSAGE_TYPE_PDF = "MESSAGE_TYPE_PDF";
    ...
    public static final String CALL_NORMAL = "CALL_NORMAL";
    public static final String CALL_CREATE_CLASSROOM = "CALL_CREATE_CLASSROOM";
    public static final String CALL_JOIN_CLASSROOM = "CALL_JOIN_CLASSROOM";
}